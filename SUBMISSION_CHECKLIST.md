...
- [x] Optional +5: publish r16 adapter to HuggingFace Hub and update `LINKS.md`. Target repo: `https://huggingface.co/bangbeo46/my-r16-adapter/`; local README is filled, upload requires HuggingFace login/token.
